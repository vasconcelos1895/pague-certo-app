...
import { Monitor, Periferico, Setor, Sistema } from "@prisma/client";
import { api } from "@/trpc/react";

export function ButtonModal({ action, data }: { action?: string, data: Monitor | null }) {
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent
          ...
          ">
          <DialogHeader>
            <DialogTitle>Cadastrar Novo Monitor</DialogTitle>
