...
import { Periferico, Sistema, Telefone } from "@prisma/client";
import { api } from "@/trpc/react";

export function ButtonModal({action ,data}:{action?: string, data:Telefone | null}) {
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>Cadastrar Novo Ramal</DialogTitle>
