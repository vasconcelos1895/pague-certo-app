...
import { Computador, Periferico, Sistema } from "@prisma/client";
import { api } from "@/trpc/react";

export function ButtonModal({action ,data}:{action?: string, data:Computador | null}) {
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>Cadastrar Novo Computador</DialogTitle>
