...
export function ButtonModal({ action, data, ataId }: { action?: string, data: DetalhesAta | null, ataId: string }) {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent
          ...
          <div className="overflow-y-auto pr-2 flex-grow">
            <CreateUpdate data={data} onSuccess={() => setOpen(false)} ataId={Number(ataId)} />
          </div>
        </DialogContent>
      </Dialog>
    </>
